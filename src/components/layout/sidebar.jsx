...
function sidebar() {
  ...
  const firstPath = pathname.match(regex)
    ? pathname.match(regex)[0]
    : pathname;

  return (
    <div className="flex flex-col h-screen p-3 w-60 max-md:hidden dark:bg-gray-900 dark:text-gray-100 custom-scrollbar">
